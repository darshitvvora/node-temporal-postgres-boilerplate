 ...
 * @param {string} mobile - User mobile number to check
 * @returns {object | null} Returns user if found, null otherwise
 */
export async function checkDuplicateByMobileActivity(mobile) {
 ...
 * @returns {object} Returns created user with id
 */
 ...
 */
export async function updateUserActivity({ id, userData }) {
 ...
 */
export async function getAllUsersActivity({ limit = 100, offset = 0 }) {
